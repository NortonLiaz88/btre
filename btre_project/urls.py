...
from pages.api_views import latest_listings_api, about_realtors_api # Importe as API views
...
urlpatterns = [
    ...
    path('api/latest-listings/', latest_listings_api, name='latest-listings-api'),
